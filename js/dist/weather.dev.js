...
var url = "https://api.openweathermap.org/data/2.5/weather?q=z\xFCrich&appid=00f2b6ac0fa1f49e57e3fea6384f3f79&units=metric";
...
fetch(url).then(function (response) {
  ...
  var div = document.createElement("div"); // li.classList.add("city");
